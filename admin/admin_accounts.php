...
<!-- admins accounts section ends  <a href="admin_accounts.php?delete=<?= $fetch_accounts['id']; ?>" class="delete-btn" onclick="return confirm('¿Eliminar esta cuenta?');">Eliminar</a>
         -->
