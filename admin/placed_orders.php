...
<section class="placed-orders">
   ...
   ?>
   <div class="box">
      <p> ID del usuario : <span><?= $fetch_orders['user_id']; ?></span> </p>
      ...
      <form action="" method="POST">
         ...
         <div class="flex-btn">
            ...
            <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('¿borrar este pedido?');">Eliminar</a>
         </div>
      </form>
   </div>
   <?php
