...
<div class="heading">
   <h3>Comprobar</h3>
   <p><a href="home.php">Inicio</a> <span> / Comprobar</span></p>
</div>
...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      <a href="cart.php" class="btn">Carrito de compra</a>
   </div>
   ...
   <div class="user-info">
      ...
      <p><i class="fas fa-map-marker-alt"></i><span><?php if($fetch_profile['address'] == ''){echo 'Por favor, introduzca su dirección';}else{echo $fetch_profile['address'];} ?></span></p>
