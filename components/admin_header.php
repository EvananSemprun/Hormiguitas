...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logo">Panel De<span> Administración</span></a>
      ...
      <div class="profile">
         ...
         <a href="../components/admin_logout.php" onclick="return confirm('Desea salir?');" class="delete-btn">Cerrar sesión</a>
      </div>
